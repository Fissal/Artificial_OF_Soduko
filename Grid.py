...
class Grid:
    ...
    def getBranches(self):
        ...
        for i in range(9):
            F[i]=0
            for j in range(9):
                if(self.matrix[i].count(None) == 0):
                    continue
                if(self.matrix[i][j] != None):
                    F[i] = F[i] + 1

        m1 = max(F.iteritems(), key=operator.itemgetter(1))[1]

        possibleValues = self.getPossibles(m1,m1)
    ...
    def getRandomBranches(self):
        ...
        for value in possibleValues:
            ...
            grid = Grid(temp)
            grid.fill()   # We should get this line to our function !
            rVal.append(grid)
        return rVal
        #return randomEmpty
    ...
    *Does not* return a new grid, updates the grid.
    ...
    def __str__(self):
        ...
        return rVal
#
# a = Grid('...7..8....6....31.4...2....24.7.....1..3..8.....6.29....8...7.86....5....2..6...')
# #s = a.getRandomBranches()
# s = a.getBranches()
# print s
